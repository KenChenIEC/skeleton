...
GPIO_CONFIG['FSI_ENABLE'] =   { 'gpio_pin': 'D5', 'direction': 'out' } ##D0->D5
GPIO_CONFIG['POWER_PIN']  =   { 'gpio_pin': 'E1', 'direction': 'out'  } 
GPIO_CONFIG['CRONUS_SEL'] =   { 'gpio_pin': 'H2', 'direction': 'out'  } ##A6->H2
GPIO_CONFIG['PGOOD']      =   { 'gpio_pin': 'F6', 'direction': 'in'  } ##C6->F6
...
GPIO_CONFIG['Button_clear'] = { 'gpio_pin': 'E2', 'direction': 'out' } 
GPIO_CONFIG['BMC_CFAM_RESET_N']    =   { 'gpio_pin': 'J2', 'direction': 'out'} ##New +
GPIO_CONFIG['BMC_RST_BTN_OUT_N']   =   { 'gpio_pin': 'E3', 'direction': 'out'} ##New +
